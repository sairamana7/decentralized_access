...
<h1>Decentralized Access control of the data from cloud </h1>
    ...
    <div id="content_wrapper">
        ...
        <div id="content_left">
        	...
        	<div id="contact_form">
                <h4>KDC Login Here!</h4>
                <form method="post" name="contact" id="ok" action="KDCLoginCheck.jsp">

                    <label for="author">User Name:</label> <input type="text" id="author" name="uname" class="required input_field" />
                    <div class="cleaner_h10"></div>
                    <label for="email">Password:</label> <input type="password" id="email" name="upass" class="validate-email required input_field" />
                    <div class="cleaner_h10"></div>
