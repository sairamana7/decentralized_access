...
<%
String query1 ="select id,filename,fileowner,filesize,uploaddate from cfile  where fileowner!=? order by id ASC";
Connection con = null;
...
<tr style="color: white">
    ...
    <td><%=fileSize%></td>
    <td><%=update%></td>
    <td style="font-weight: bold"><a href="CDecentral.jsp?id=<%=id%>&owner=<%=fileowner%>&name=<%=name%>&filename=<%=filename%>">Request</a> </td></tr>
