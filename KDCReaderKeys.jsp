...
Connection con = null;
    ...
    final String query = "update readerkdc set readersecretkey=? where fileid=? and ownername=?";
    try{
      ...
      if(no>0){
      JOptionPane.showMessageDialog(null,"Secret key success");
      response.sendRedirect("KDCHome.jsp?msg=success");
      }

      else{
          JOptionPane.showMessageDialog(null,"Secret key Error");
         response.sendRedirect("KDCHome.jsp?msg=error");
