...
ResultSet rs = null;
final String query="select distinct fileid,ownername,filename,readersecretkey from WritertoCreator where ownername=? and readersecretkey=?";
try{
...
<tr style="color: white">
     ...
     <td><%=filename%></td>
     <td><%=skey%></td>
     <td><a href="GrantPermissionToWritor.jsp?fid=<%=fid%>&filename=<%=filename%>&oname=<%=oname%>">Approve</a> 
     <a href="RejectPermissionToWritor.jsp?fid=<%=fid%>&filename=<%=filename%>&oname=<%=oname%>">Reject</a> </td>
