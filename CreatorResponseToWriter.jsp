...
<h1>Decentralized Access control of the data from cloud </h1>
    ...
    <div id="menu">
        <ul>
            <li><a href="WriterHome.jsp.jsp" class="current">Home</a></li>
...
ResultSet rs = null;
final String query="select distinct fileid,ownername,filename,readersecretkey from WritertoCreator where readername=? and readersecretkey!=?";
try{
...
<tr style="color: white">
     ...
     <td><%=filename%></td>
     <td><%=skey%></td>
     <td><a href="WriterMofifyTheData.jsp?fid=<%=fid%>&filename=<%=filename%>&oname=<%=oname%>">Modify</a> </td>
