...
<tr style="color: white">
   ...
   <!-- <td style="font-weight: bold"><a href="FileViewByReader.jsp?id=<%=id%>">View</a> </td>-->
  <td style="font-weight: bold"><a href="ReaderRequestToKDC.jsp?id=<%=id%>&owner=<%=fileowner%>&filename=<%=filename%>">Request</a> </td>
