        ...
        <div id="content_left">
        	...
        	<div id="contact_form">
                <h4>Welcome To :!<%=name%></h4>
                   ...
                   <form method="post" name="contact" id="ok" action="CRequestKDC1.jsp">

                    <label for="author">Token ID:</label> <input type="text" id="author" name="tokenID" class="required input_field" />
