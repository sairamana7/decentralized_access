...
<h1>Decentralized Access control of the data from cloud </h1>
    ...
    <div id="menu">
        <ul>
            <li><a href="TrusteeHome.jsp" class="current">Home</a></li>
            <li><a href="CRequestDetails.jsp">Request Details</a></li>
...
<%
String query = "select *from requesttokens order by id";
Connection con = null;
...
<tr style="color: RED">
    ...
    <td><%=name%></td>
    <td><%=key%></td>
    <td><a href="TrusteeGenerattokens.jsp?name=<%=id%>">Response</a>  </td>
</tr>
