...
<%String name = (String)session.getAttribute("name"); %>
    ...
    <div id="content_wrapper">
        ...
        <div id="content_left">
<h3><a href="DecentralizedData.jsp?name=<%=name%>">Decentralized Data</a></h3> <h3><a href="RequestFileData.jsp">Requested Files</a></h3>
        	<div id="contact_form">
...
String query = "update decentral set stattus=? where id=? and requester=? and receptors=?";
...
if(no>0){
response.sendRedirect("RequestFileData.jsp?msg=Granted for the user"+requester);
}
else{
response.sendRedirect("RequestFileData.jsp?msg=Faild");
}
}catch(Exception e){
