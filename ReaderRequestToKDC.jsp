...
String query ="insert into readerkdc values(?,?,?,?,?)";
try{
...
if(no>0){
JOptionPane.showMessageDialog(null, "Request Successfully sent to KDC");
response.sendRedirect("ReaderHome.jsp?msg=success");
}
else{
